...
local variable_jour = "Jour"                        -- nom de la variable Saint du jour, nil si inutilisé
local variable_lendemain = "Lendemain"              -- nom de la variable Saint du lendemain, nil si inutilisé
...
local version = "1.70"                            -- version du script
local fete_jour = ''
local fete_demain = ''
local ferie =  ''
local anniversaire = {}
...
-- Famille Anthony
anniversaire["08:02"]="l\'anniversaire&nbsp;de&nbsp;Paul"
anniversaire["27:03"]="l\'anniversaire&nbsp;de&nbsp;Maman"
anniversaire["01:05"]="l\'anniversaire&nbsp;de&nbsp;Papa"
anniversaire["29:04"]="l\'anniversaire&nbsp;de&nbsp;Patrick"
anniversaire["01:08"]="l\'anniversaire&nbsp;de&nbsp;Florine"
anniversaire["31:05"]="l\'anniversaire&nbsp;de&nbsp;Alexis"
anniversaire["11:09"]="l\'anniversaire&nbsp;de&nbsp;Angelique"
anniversaire["24:06"]="l\'anniversaire&nbsp;de&nbsp;Bruno"
anniversaire["09:06"]="l\'anniversaire&nbsp;de&nbsp;Timothe"
anniversaire["28:05"]="l\'anniversaire&nbsp;de&nbsp;Eleane"
anniversaire["17:03"]="l\'anniversaire&nbsp;de&nbsp;Cindy"
anniversaire["30:11"]="l\'anniversaire&nbsp;de&nbsp;MaiLanNOK"
anniversaire["02:12"]="l\'anniversaire&nbsp;de&nbsp;Janae"
anniversaire["30:05"]="l\'anniversaire&nbsp;de&nbsp;IdrissaNOK"
anniversaire["20:03"]="l\'anniversaire&nbsp;de&nbsp;Parrain"
anniversaire["11:07"]="l\'anniversaire&nbsp;de&nbsp;Nathalie"
anniversaire["13:07"]="l\'anniversaire&nbsp;de&nbsp;Caroline"
anniversaire["13:12"]="l\'anniversaire&nbsp;de&nbsp;Thomas"
anniversaire["02:03"]="l\'anniversaire&nbsp;de&nbsp;Corinne"
anniversaire["10:03"]="l\'anniversaire&nbsp;de&nbsp;Marjolaine"
anniversaire["30:05"]="l\'anniversaire&nbsp;de&nbsp;LeaNOK"
anniversaire["14:07"]="l\'anniversaire&nbsp;de&nbsp;Marraine"

-- Maison
anniversaire["02:10"]="l\'anniversaire&nbsp;de&nbsp;Anthony"
anniversaire["03:10"]="l\'anniversaire&nbsp;de&nbsp;Agathe"
anniversaire["28:06"]="l\'anniversaire&nbsp;de&nbsp;Claire"

anniversaire["01:09"]="nos&nbsp;".. annee_mariage .."&nbsp;ans&nbsp;de&nbsp;mariage"

-- Famille Claire
anniversaire["07:02"]="l\'anniversaire&nbsp;de&nbsp;Christelle"
anniversaire["02:09"]="l\'anniversaire&nbsp;de&nbsp;David"
anniversaire["17:03"]="l\'anniversaire&nbsp;de&nbsp;Yuna"
anniversaire["23:06"]="l\'anniversaire&nbsp;de&nbsp;Lea"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;Christine"
anniversaire["08:01"]="l\'anniversaire&nbsp;de&nbsp;Bernard"
anniversaire["07:09"]="l\'anniversaire&nbsp;de&nbsp;Cindy"
anniversaire["27:06"]="l\'anniversaire&nbsp;de&nbsp;Philippe"

-- Amis
anniversaire["16:07"]="l\'anniversaire&nbsp;de&nbsp;Mag"
anniversaire["20:01"]="l\'anniversaire&nbsp;de&nbsp;Seb"
anniversaire["06:01"]="l\'anniversaire&nbsp;de&nbsp;Noah"
anniversaire["21:05"]="l\'anniversaire&nbsp;de&nbsp;TessNOK"
anniversaire["11:01"]="l\'anniversaire&nbsp;de&nbsp;Nolwen"
anniversaire["29:06"]="l\'anniversaire&nbsp;de&nbsp;JeanJean"
anniversaire["23:01"]="l\'anniversaire&nbsp;de&nbsp;LouaneNOK"
anniversaire["23:01"]="l\'anniversaire&nbsp;de&nbsp;AlexisJeanJeanNOK"
anniversaire["13:07"]="l\'anniversaire&nbsp;de&nbsp;SebCoyNOK"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;PierreGuevel"
anniversaire["13:03"]="l\'anniversaire&nbsp;de&nbsp;Dede"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;MoumouthNOK"
anniversaire["15:03"]="l\'anniversaire&nbsp;de&nbsp;Delphine"
anniversaire["10:07"]="l\'anniversaire&nbsp;de&nbsp;Xavier"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;AgnesNOK"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;CloeNOK"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;JulieNOK"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;WilliamNOK"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;CharlineNOK"
anniversaire["23:02"]="l\'anniversaire&nbsp;de&nbsp;AnthoCottinNOK"
...
saint_jour["11:05"]="les&nbsp;Estelle&nbsp;\xE2\x9D\x84"
saint_jour["12:05"]="les&nbsp;Achille&nbsp;\xE2\x9D\x84"
saint_jour["13:05"]="les&nbsp;Rolande&nbsp;\xE2\x9D\x84"
saint_jour["14:05"]="les&nbsp;Matthias&nbsp;\xE2\x9D\x84"
saint_jour["15:05"]="les&nbsp;Denise&nbsp;\xE2\x9D\x84"
...
--local annee = "2017"
voir_les_logs("--- --- --- nombre de jours en février : ".. LeapYear(annee),debugging)
...
local derJourFevrier = tonumber(os.date("%w",os.time{year=annee,month=2,day=LeapYear(annee)}))      -- dernier jour de Mars
local premDimMars  = deuxDigits(7-derJourFevrier)..":03"
voir_les_logs("--- --- --- premDimMars : ".. premDimMars,debugging)
local epochPaques=getJourPaques(annee)
local paques = os.date("%d:%m",epochPaques)
voir_les_logs("--- --- --- Pâques : ".. paques,debugging)
local vendredi_saint = os.date("%d:%m",epochPaques-(24*60*60*2)) -- vendredi saint = Pâques - 2 jours
voir_les_logs("--- --- --- vendredi saint : ".. vendredi_saint,debugging)
...
local derJourSeptembre = tonumber(os.date("%w",os.time{year=annee,month=9,day=30}))      -- dernier jour de Mars
local premDimOctobre  = deuxDigits(7-derJourSeptembre)..":10"
voir_les_logs("--- --- --- premDimOctobre : ".. premDimOctobre,debugging)
...
--===========================================================
    ...
    elseif premDimMars == today then
        fete_jour = "les&nbsp;Grand-Mères"
        voir_les_logs("--- --- --- Aujourd&apos;hui : ".. fete_jour,debugging)
    ...
    elseif ferie_vendredi_saint == true and vendredi_saint == today then
        fete_jour = "vendredi saint"
        ferie = true
            voir_les_logs("--- --- --- Aujourd&apos;hui : ".. fete_jour,debugging)
    ...
    elseif jour_ferie[today] ~= nil then
        ...
        voir_les_logs("--- --- --- Aujourd&apos;hui : ".. fete_jour,debugging)
        elseif premDimOctobre == today then
        fete_jour = "la&nbsp;Fête&nbsp;des&nbsp;Grand-Pères"
        voir_les_logs("--- --- --- Aujourd&apos;hui : ".. fete_jour,debugging)
    ...
    elseif meres == tomorrow then
        ...
        voir_les_logs("--- --- --- Demain : ".. fete_demain,debugging)
    elseif premDimMars == tomorrow then
        fete_demain = "la&nbsp;Fête&nbsp;des&nbsp;Grand-Mères"
        voir_les_logs("--- --- --- Demain : ".. fete_demain,debugging)
    elseif troisDimJuin == tomorrow then
        fete_demain = "la&nbsp;Fête&nbsp;des&nbsp;pères"
        voir_les_logs("--- --- --- Demain : ".. fete_demain,debugging)
    elseif ferie_vendredi_saint == true and vendredi_saint == tomorrow then
        fete_demain = "vendredi saint"
        voir_les_logs("--- --- --- Demain : ".. fete_demain,debugging)
    ...
    elseif lundi_pentecote == tomorrow then
        ...
        voir_les_logs("--- --- --- Demain : ".. fete_demain,debugging)
        elseif premDimOctobre == tomorrow then
        fete_demain = "la&nbsp;Fête&nbsp;des&nbsp;Grand-Pères"
        voir_les_logs("--- --- --- Demain : ".. fete_demain,debugging)
    ...
    voir_les_logs("--- --- --- jour de la semaine : ".. date_en_francais(os.date("%A")),debugging)
    voir_les_logs("--- --- --- jour de la semaine (nb) : ".. os.date("*t").wday,debugging)
    if jour_semaine_switch ~= nil then
    local select_day = os.date("*t").wday.."0"
        commandArray[jour_semaine_switch] = 'Set Level: '.. select_day
        voir_les_logs("--- --- --- Mise à jour device  ".. jour_semaine_switch .." => "..select_day,debugging)
    end
