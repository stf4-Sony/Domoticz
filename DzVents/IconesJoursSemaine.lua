...
return  {   
   ...
   logging =   {  level    =   domoticz.LOG_DEBUG,                                             -- Seulement un niveau peut être actif; commenter les autres
    ...
    execute = function(dz, item)
        ...
        local icons =     { 
                            [10] = 124,-- level correspondant à dimanche
                            [20] = 118,-- level correspondant à lundi
                            [30] = 119,-- level correspondant à mardi
                            [40] = 120,-- level correspondant à mercredi
                            [50] = 121,-- level correspondant à jeudi
                            [60] = 122,-- level correspondant à vendredi
                            [70] = 123,-- level correspondant à samedi
